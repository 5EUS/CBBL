...
public static class Logger
{
    ...
    public static readonly string FilePath = Path.Combine(PlatformHelper.ProjectRoot, "logs", "log.bin");
    private static readonly StreamWriter _writer = new(FilePath, true);
    public static TextWriter _altOut = Console.Out;
